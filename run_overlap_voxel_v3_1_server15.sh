...
GPU="${GPU:-2}"
OUTPUT_ROOT="${OUTPUT_ROOT:-/data4/daixiangting/inspatio_v3_1_results}"
...
run_case() {
    ...
    python scripts/summarize_overlap_voxel_v3.py \
        ...
        --csv "${OUTPUT_ROOT}/${case_name}_v3_1_block_timings.csv" \
        --summary-json "${OUTPUT_ROOT}/${case_name}_v3_1_summary.json"
}
